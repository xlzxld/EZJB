...
| 主干分支 | `main`（remote `origin` → `https://github.com/xlzxld/EZJB.git`） | ✅ 禁止未经 Pull Request 直接向 main 提交；基线 tag `v1.0.2` |
